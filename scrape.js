...
const QUERIES = [
  ...
  // 2026-05-19 Rose 問 Meta Quest 2 $4K 之前 VR query 連 9 輪空 換用品牌名重啟
  { q: 'Meta Quest', min: 1000, max: 10000, maxDays: 7 },
  { q: 'Oculus', min: 1000, max: 10000, maxDays: 7 },
  ...
  { q: '黑膠', min: 500, max: 8000, maxDays: 7 },
  { q: 'Switch 遊戲片', min: 500, max: 5000, maxDays: 7 },
  { q: 'PS5', min: 3000, max: 20000, maxDays: 7 },
  { q: 'Steam Deck', min: 5000, max: 20000, maxDays: 7 },
  ...
  // 2026-05-18 防水/游泳耳機 Rose 詢問
  { q: '游泳耳機', min: 500, max: 8000, maxDays: 7 },
